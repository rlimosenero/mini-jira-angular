  ...
  template: `
    ...
    >
      @switch (name()) {
        ...
        @case ('ticket') {
          <path d="M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v1.5a1.5 1.5 0 0 0 0 3V15a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1.5a1.5 1.5 0 0 0 0-3V9z"></path>
          <line x1="13" y1="8" x2="13" y2="16" stroke-dasharray="2 2"></line>
        }
        @case ('users') {
